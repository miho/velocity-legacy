package eu.mihosoft.ext.velocity.legacy.runtime.resource.util;
...
import eu.mihosoft.ext.velocity.legacy.runtime.resource.loader.StringResourceLoader;
...
public class StringResourceRepositoryImpl implements StringResourceRepository
{
    ...
    /**
     * @see eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResourceRepository#getEncoding()
     */
    ...
    /**
     * @see eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResourceRepository#setEncoding(java.lang.String)
     */
