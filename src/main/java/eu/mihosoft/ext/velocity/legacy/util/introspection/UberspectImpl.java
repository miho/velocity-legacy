package eu.mihosoft.ext.velocity.legacy.util.introspection;
...
import eu.mihosoft.ext.velocity.legacy.runtime.RuntimeLogger;
import eu.mihosoft.ext.velocity.legacy.runtime.log.Log;
import eu.mihosoft.ext.velocity.legacy.runtime.log.RuntimeLoggerLog;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.AbstractExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.BooleanPropertyExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.GetExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.MapGetExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.MapSetExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.PropertyExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.PutExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.SetExecutor;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.node.SetPropertyExecutor;
import eu.mihosoft.ext.velocity.legacy.util.ArrayIterator;
import eu.mihosoft.ext.velocity.legacy.util.ArrayListWrapper;
import eu.mihosoft.ext.velocity.legacy.util.EnumerationIterator;
...
public class UberspectImpl implements Uberspect, UberspectLoggable
{
    ...
    public static class VelMethodImpl implements VelMethod
    {
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelMethod#isCacheable()
         */
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelMethod#getMethodName()
         */
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelMethod#getReturnType()
         */
    ...
    public static class VelGetterImpl implements VelPropertyGet
    {
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelPropertyGet#invoke(java.lang.Object)
         */
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelPropertyGet#isCacheable()
         */
        public boolean isCacheable()
        {
            return true;
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelPropertyGet#getMethodName()
         */
        public String getMethodName()
        {
    ...
    public static class VelSetterImpl implements VelPropertySet
    {
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelPropertySet#isCacheable()
         */
        public boolean isCacheable()
        {
            return true;
        ...
        /**
         * @see eu.mihosoft.ext.velocity.legacy.util.introspection.VelPropertySet#getMethodName()
         */
        public String getMethodName()
        {
