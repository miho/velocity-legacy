...
import eu.mihosoft.ext.velocity.legacy.app.event.EventHandlerUtil;
...
import eu.mihosoft.ext.velocity.legacy.runtime.Renderable;
import eu.mihosoft.ext.velocity.legacy.runtime.RuntimeConstants;
import eu.mihosoft.ext.velocity.legacy.runtime.directive.Block.Reference;
...
import eu.mihosoft.ext.velocity.legacy.util.introspection.Info;
import eu.mihosoft.ext.velocity.legacy.util.introspection.VelMethod;
import eu.mihosoft.ext.velocity.legacy.util.introspection.VelPropertySet;
...
public class ASTReference extends SimpleNode
{
    ...
    /**
     * @see eu.mihosoft.ext.velocity.legacy.runtime.parser.node.SimpleNode#init(eu.mihosoft.ext.velocity.legacy.context.InternalContextAdapter, java.lang.Object)
     */
