 ...
 *
 * @see eu.mihosoft.ext.velocity.legacy.runtime.RuntimeInstance
 *
...
public class RuntimeSingleton implements RuntimeConstants
{
    ...
    */
     ...
     *
     * @see eu.mihosoft.ext.velocity.legacy.runtime.RuntimeServices#getApplicationAttribute(Object)
     * @param key
     ...
     * @see eu.mihosoft.ext.velocity.legacy.runtime.RuntimeServices#getUberspect()
