...
public abstract class AbstractChainableUberspector extends UberspectImpl implements ChainableUberspector
{
     ...
     * {@inheritDoc}
     * 
     * @see ChainableUberspector#wrap(eu.mihosoft.ext.velocity.legacy.util.introspection.Uberspect)
     * @see #inner
     */
     ...
     * 
     * @see eu.mihosoft.ext.velocity.legacy.util.introspection.Uberspect#init()
     */
    //@Override
    public void init()
    {
     ...
     * {@inheritDoc}
     * 
     * @see eu.mihosoft.ext.velocity.legacy.util.introspection.Uberspect#getIterator(java.lang.Object,
     *      eu.mihosoft.ext.velocity.legacy.util.introspection.Info)
     */
     ...
     * {@inheritDoc}
     * 
     * @see eu.mihosoft.ext.velocity.legacy.util.introspection.Uberspect#getMethod(java.lang.Object, java.lang.String,
     *      java.lang.Object[], eu.mihosoft.ext.velocity.legacy.util.introspection.Info)
     */
    //@Override
     ...
     * {@inheritDoc}
     * 
     * @see eu.mihosoft.ext.velocity.legacy.util.introspection.Uberspect#getPropertyGet(java.lang.Object, java.lang.String,
     *      eu.mihosoft.ext.velocity.legacy.util.introspection.Info)
     */
    //@Override
     ...
     * {@inheritDoc}
     * 
     * @see eu.mihosoft.ext.velocity.legacy.util.introspection.Uberspect#getPropertySet(java.lang.Object, java.lang.String,
     *      java.lang.Object, eu.mihosoft.ext.velocity.legacy.util.introspection.Info)
     */
    //@Override
