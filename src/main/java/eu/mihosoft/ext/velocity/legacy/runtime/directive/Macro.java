...
import eu.mihosoft.ext.velocity.legacy.runtime.parser.ParserTreeConstants;
...
public class Macro extends Directive
{
    ...
    /**
     * @see eu.mihosoft.ext.velocity.legacy.runtime.directive.Directive#init(eu.mihosoft.ext.velocity.legacy.runtime.RuntimeServices, eu.mihosoft.ext.velocity.legacy.context.InternalContextAdapter, eu.mihosoft.ext.velocity.legacy.runtime.parser.node.Node)
     */
