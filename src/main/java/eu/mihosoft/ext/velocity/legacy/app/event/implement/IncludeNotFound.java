package eu.mihosoft.ext.velocity.legacy.app.event.implement;
...
import eu.mihosoft.ext.velocity.legacy.util.ContextAware;
...
public class IncludeNotFound implements IncludeEventHandler,RuntimeServicesAware,ContextAware {
    ...
    /**
     * @see eu.mihosoft.ext.velocity.legacy.util.RuntimeServicesAware#setRuntimeServices(eu.mihosoft.ext.velocity.legacy.runtime.RuntimeServices)
     */
    ...
    /** 
     * @see eu.mihosoft.ext.velocity.legacy.util.ContextAware#setContext(eu.mihosoft.ext.velocity.legacy.context.Context)
     */ 
