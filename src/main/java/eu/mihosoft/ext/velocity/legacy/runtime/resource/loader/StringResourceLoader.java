...
import eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResource;
import eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResourceRepository;
import eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResourceRepositoryImpl;
 ...
 * string.resource.loader.class = eu.mihosoft.ext.velocity.legacy.runtime.resource.loader.StringResourceLoader
 * string.resource.loader.repository.class = eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResourceRepositoryImpl
 * </pre>
 ...
 * 'eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResourceRepositoryImpl').
...
public class StringResourceLoader extends ResourceLoader
{
     ...
     * ('eu.mihosoft.ext.velocity.legacy.runtime.resource.util.StringResourceRepository').
     * @since 1.6
     */
    ...
    /**
     * @see eu.mihosoft.ext.velocity.legacy.runtime.resource.loader.ResourceLoader#init(org.apache.commons.collections.ExtendedProperties)
     */
