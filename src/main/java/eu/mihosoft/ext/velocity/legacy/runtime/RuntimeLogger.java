...
public interface RuntimeLogger
{
     ...
     * @see eu.mihosoft.ext.velocity.legacy.runtime.log.Log#warn(Object)
     ...
     * @see eu.mihosoft.ext.velocity.legacy.runtime.log.Log#info(Object)
     * @param message The message to log.
     */
     ...
     * @see eu.mihosoft.ext.velocity.legacy.runtime.log.Log#error(Object)
     * @param message The message to log.
     */
     ...
     * @see eu.mihosoft.ext.velocity.legacy.runtime.log.Log#debug(Object)
     * @param message The message to log.
     */
