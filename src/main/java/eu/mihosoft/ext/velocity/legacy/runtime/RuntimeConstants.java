...
public interface RuntimeConstants
{
     ...
     * {@link eu.mihosoft.ext.velocity.legacy.runtime.resource.ResourceCache} implementation to use.
     */
     ...
     * {@link eu.mihosoft.ext.velocity.legacy.app.event.ReferenceInsertionEventHandler} implementations to use.
     */
     ...
     * {@link eu.mihosoft.ext.velocity.legacy.app.event.NullSetEventHandler} implementations to use.
     */
     ...
     * {@link eu.mihosoft.ext.velocity.legacy.app.event.MethodExceptionEventHandler} implementations to use.
     */
     ...
     * {@link eu.mihosoft.ext.velocity.legacy.app.event.IncludeEventHandler} implementations to use.
     */
     ...
     * {@link eu.mihosoft.ext.velocity.legacy.app.event.InvalidReferenceEventHandler} implementations to use.
     */
    ...
    /**
     * The <code>parser.pool.class</code> property specifies the name of the {@link eu.mihosoft.ext.velocity.legacy.util.SimplePool}
    ...
    String DEFAULT_RUNTIME_PROPERTIES = "eu/mihosoft/ext/velocity/legacy/runtime/defaults/velocity.properties";

    /** Default Runtime properties. */
    String DEFAULT_RUNTIME_DIRECTIVES = "eu/mihosoft/ext/velocity/legacy/runtime/defaults/directive.properties";
