package eu.mihosoft.ext.velocity.legacy.runtime;
...
import eu.mihosoft.ext.velocity.legacy.Template;
import eu.mihosoft.ext.velocity.legacy.app.event.EventCartridge;
import eu.mihosoft.ext.velocity.legacy.app.event.EventHandler;
import eu.mihosoft.ext.velocity.legacy.app.event.IncludeEventHandler;
import eu.mihosoft.ext.velocity.legacy.app.event.InvalidReferenceEventHandler;
import eu.mihosoft.ext.velocity.legacy.app.event.MethodExceptionEventHandler;
import eu.mihosoft.ext.velocity.legacy.app.event.NullSetEventHandler;
import eu.mihosoft.ext.velocity.legacy.app.event.ReferenceInsertionEventHandler;
import eu.mihosoft.ext.velocity.legacy.context.Context;
import eu.mihosoft.ext.velocity.legacy.context.InternalContextAdapterImpl;
...
import eu.mihosoft.ext.velocity.legacy.runtime.directive.Directive;
import eu.mihosoft.ext.velocity.legacy.runtime.directive.Scope;
import eu.mihosoft.ext.velocity.legacy.runtime.directive.StopCommand;
import eu.mihosoft.ext.velocity.legacy.runtime.log.Log;
import eu.mihosoft.ext.velocity.legacy.runtime.log.LogManager;
import eu.mihosoft.ext.velocity.legacy.runtime.parser.ParseException;
...
import eu.mihosoft.ext.velocity.legacy.runtime.resource.ContentResource;
import eu.mihosoft.ext.velocity.legacy.runtime.resource.ResourceManager;
import eu.mihosoft.ext.velocity.legacy.runtime.resource.ResourceManagerImpl;
import eu.mihosoft.ext.velocity.legacy.util.ClassUtils;
import eu.mihosoft.ext.velocity.legacy.util.RuntimeServicesAware;
import eu.mihosoft.ext.velocity.legacy.util.StringUtils;
import eu.mihosoft.ext.velocity.legacy.util.introspection.ChainableUberspector;
import eu.mihosoft.ext.velocity.legacy.util.introspection.Introspector;
import eu.mihosoft.ext.velocity.legacy.util.introspection.LinkingUberspector;
import eu.mihosoft.ext.velocity.legacy.util.introspection.Uberspect;
import eu.mihosoft.ext.velocity.legacy.util.introspection.UberspectLoggable;
...
public class RuntimeInstance implements RuntimeConstants, RuntimeServices
{
    ...
    private void initializeDirectives()
    {
         ...
         *
         * eu.mihosoft.ext.velocity.legacy.runtime.directive.Foreach
         */
    ...
    */
     ...
     * Adds a new Velocimacro. Usually called by Macro only while parsing.
     * 
     * Called by eu.mihosoft.ext.velocity.legacy.runtime.directive.processAndRegister
     *
     * @param name  Name of velocimacro
