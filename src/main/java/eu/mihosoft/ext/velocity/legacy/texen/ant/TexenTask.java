package eu.mihosoft.ext.velocity.legacy.texen.ant;
...
import eu.mihosoft.ext.velocity.legacy.texen.Generator;
            ...
            if (useClasspath)
            {
                ...
                ve.setProperty(
                    "classpath." + VelocityEngine.RESOURCE_LOADER + ".class",
                        "eu.mihosoft.ext.velocity.legacy.runtime.resource.loader.ClasspathResourceLoader");
